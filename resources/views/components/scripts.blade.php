...
<script src="{{ front_asset('libs/Vimeo-Youtube-Video-Popup-Plugin-jQuery/src/video.popup.min.js')}}"></script>
@stack('lib-scripts')
...
<script src="{{front_asset('js/custom.min.js')}}"></script>
<script src="{{front_asset('js/activenav.min.js')}}"></script>
<script src="{{front_asset('js/youtube-popup.min.js')}}"></script>
