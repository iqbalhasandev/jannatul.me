<x-app-layout>
    <section class="shadow-blue white-bg padding">
        ...
        <div class="row pt-4 align-items-center justify-content-center">
            <div class="col-sm-5">
                <div class="">
                    <img src="{{ front_asset('images/errors/403.png') }}" alt="" class="img-fluid mx-auto d-block"
                        style="max-height: 400px">
                </div>

                <div class="text-center mb-5">
                    <h1 class="font-large-2 my-1">403</h1>
                    <p class="px-2">
                        {{ $exception->getMessage() ?: 'Forbidden this area is off limits!.'}}
                        <em>
                            <strong>
